...
@implementation SongNameTableViewController
...
- (void)viewDidLoad
{
   ...
   // songImgList = [[NSMutableArray alloc]initWithObjects:@"GoodMorning",@"WhiteChrismas",@"Jinglebells",@"LondonBridge", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImageView* contactImageView = [[UIImageView alloc]initWithFrame:CGRectMake(10 ,5, 50, 50)];

    contactImageView.image =[UIImage imageNamed:[songList objectAtIndex:indexPath.row]];
